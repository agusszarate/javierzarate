        ...
        >
          ...
          <SelectContent>
            {state.activarMarca.id ? (
              ...
              <SelectItem value="no-brand" disabled>Selecciona una marca primero</SelectItem>
            )}
          </SelectContent>
        </Select>
      </div>
          ...
          <SelectContent>
            {state.activarModelo.code ? (
              state.activarYears.length > 0 ? (
                ...
                <SelectItem value="loading" disabled>Cargando años...</SelectItem>
              )
            ) : (
              <SelectItem value="no-model" disabled>Selecciona un modelo primero</SelectItem>
            )}
          </SelectContent>
        </Select>
      </div>
